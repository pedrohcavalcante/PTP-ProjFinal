 ...
 * @param *flood é ponteiro da matriz
 * @param jogadas é o número de jogadas que o usuário está no momento que salvou o jogo.
 * @return void.
*/
...
int carregar (dados_matriz *flood1, int jogadas);
  ...
  * @return retorna para a função principal o número de jogadas que estava no arquivo.
  */
